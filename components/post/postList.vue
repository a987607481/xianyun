    ...
    <div class="post-item">
      ...
      <el-row type="flex" justify="space-between" class="post-info">
        <el-row type="flex" align="middle" class="post-info-left">
          ...
          <span>
            <i class="el-icon-view" /> 666666
          </span>
        </el-row>
        <span class="post-info-right">66 赞</span>
      </el-row>
    </div>
    <!-- 左右布局 -->
    <el-row type="flex" justify="space-between" align="middle" class="post-item">
      ...
      <div class="post-content">
        ...
        <p class="post-desc">
          <a href="">想象一下一个距离 北京 只有2.5小时飞行距离的城市：身处 亚洲 却能感受到十足的欧陆风情——欧式建筑和街道，金发碧眼的路人，正宗的西餐外加只有国内一半售价的帝王蟹可以敞开吃——更难能可贵的是，这里对国人（实质）免签，有直飞航班，低廉的物价，且尚未有太多的游客涉足还保留着原汁原味的传统风情！</a>
        </p>
        <el-row type="flex" justify="space-between" class="post-info">
          <el-row type="flex" align="middle" class="post-info-left">
            <span>
